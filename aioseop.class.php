...
*/
	...
	function seo_mrt_admin_head() {
		...
		$stylesheet = WP_PLUGIN_URL . '/fv-all-in-one-seo-pack/style.css';
...
/*	        if ($page && $page > 1) {
	...
	function get_post_description($post) {
		...
		if (!$description) {
            ///   Modification    15/10/09    Foliovision
			if($aioseop_options['aiosp_dont_use_excerpt']) {
                if ($aioseop_options["aiosp_generate_descriptions"]) {
            ...
            ///   End of Modification    15/10/09    Foliovision			
		}
...
//		if (!wp_verify_nonce($nonce, 'edit-aioseop-nonce')) die ( 'Security Check - If you receive this in error, log out and back in to WordPress');
	...
	function edit_category_form() {
		...
		<a href="http://wp.uberdose.com/2007/03/24/all-in-one-seo-pack/"><?php _e('FV All in One SEO Pack', 'all_in_one_seo_pack') ?></a>
		</th>
		</tr>
		<tr>
	...
	function add_meta_tags_textinput() {
	 ...
	 <?php if (substr($this->wp_version, 0, 3) >= '2.5') { ?>
                ...
                <h3><?php _e('FV All in One SEO Pack', 'all_in_one_seo_pack') ?></h3>
                <div class="inside">
                <div id="postaiosp">
                <?php } else { ?>
                ...
                <h3 class="dbx-handle"><?php _e('FV All in One SEO Pack', 'all_in_one_seo_pack') ?></h3>
                </div>
...
<input type="hidden" name="nonce-aioseop-edit" value="<?php echo wp_create_nonce('edit-aioseop-nonce'); ?>" />
	...
	function admin_menu() {
		...
		add_submenu_page('options-general.php', __('FV All in One SEO', 'all_in_one_seo_pack'), __('FV All in One SEO', 'all_in_one_seo_pack'), 10, $file, array($this, 'options_panel'));
	}
	...
	function options_panel() {
		...
		if(!$aioseop_options['aiosp_cap_cats']){
			...
			if ($_POST['action'] && $_POST['action'] == 'aiosp_update' && $_POST['Submit_Default']!='') {
				...
				$message = __("FV All in One SEO Options Reset.", 'all_in_one_seo_pack');
		...
		if ($_POST['action'] && $_POST['action'] == 'aiosp_update' && $_POST['Submit']!='') {
			$nonce = $_POST['nonce-aioseop'];
			if (!wp_verify_nonce($nonce, 'aioseop-nonce')) die ( 'Security Check - If you receive this in error, log out and back in to WordPress');
			$message = __("FV All in One SEO Options Updated.", 'all_in_one_seo_pack');
            ...
            $aioseop_options['aiosp_dont_use_excerpt'] = $_POST['aiosp_dont_use_excerpt'];
            $aioseop_options['aiosp_show_keywords'] = $_POST['aiosp_show_keywords'];		
...
<div class="wrap">
<h2><?php _e('FV All in One SEO Plugin Options', 'all_in_one_seo_pack'); ?></h2>
...
&nbsp;<a target="_blank" title="<?php _e('FV All in One SEO Plugin Release History', 'all_in_one_seo_pack')?>"
...
<?php ///   Modification    15/10/09    Foliovision ?>
...
-->
<?php ///   End of Modification    15/10/09    Foliovision ?>
</p>
...
<?php
_e('FV All in One SEO Pack must be enabled for use.', 'all_in_one_seo_pack');
 ?>
</div>
</td>
</tr>
...
<?php
_e("Enter any comma separated pages here to be excluded by FV All in One SEO Pack.  This is helpful when using plugins which generate their own non-WordPress dynamic pages.  Ex: <em>/forum/,/contact/</em>  For instance, if you want to exclude the virtual pages generated by a forum plugin, all you have to do is give forum or /forum or /forum/ or and any URL with the word \"forum\" in it, such as http://mysite.com/forum or http://mysite.com/forum/someforumpage will be excluded from FV All in One SEO Pack.", 'all_in_one_seo_pack');
 ?>
</div>
</td>
</tr>
...
<?php ///   Addition    15/10/09    Foliovision ?>
<!-- extra options for FV All in One SEO Pack -->
<tr>
<td colspan="2">FV extra options:<hr /></td>
</tr>
<tr>
<th scope="row" style="text-align:right; vertical-align:top;">
<a style="cursor:pointer;" title="<?php _e('Click for Help!', 'all_in_one_seo_pack')?>" onclick="toggleVisibility('aiosp_dont_use_excerpt_tip');">
<?php _e('Turn off excerpts for descriptions:', 'all_in_one_seo_pack')?>
</a>
</td>
<td>
<input type="checkbox" name="aiosp_dont_use_excerpt" <?php if ($aioseop_options['aiosp_dont_use_excerpt']) echo "checked=\"1\""; ?>/>
<div style="max-width:500px; text-align:left; display:none" id="aiosp_dont_use_excerpt_tip">
<?php
...
<tr>
<th scope="row" style="text-align:right; vertical-align:top;">
<a style="cursor:pointer;" title="<?php _e('Click for Help!', 'all_in_one_seo_pack')?>" onclick="toggleVisibility('aiosp_show_keywords_tip');">
<?php _e('Add keywords field to post editing screen:', 'all_in_one_seo_pack')?>
</a>
</td>
<td>
<input type="checkbox" name="aiosp_show_keywords" <?php if ($aioseop_options['aiosp_show_keywords']) echo "checked=\"1\""; ?>/>
<div style="max-width:500px; text-align:left; display:none" id="aiosp_show_keywords_tip">
<?php
_e("You don't need this field at all if you are using tags properly. It makes the All in One SEO in the editing screen more complicated too.", 'all_in_one_seo_pack');
 ?>
</div>
</td>
</tr>
<!-- -->
<?php ///   End of Addition    15/10/09    Foliovision ?>
