...
require_once( WP_PLUGIN_DIR . '/fv-all-in-one-seo-pack/aioseop.class.php');
...
function aioseop_activation_notice(){
	global $aioseop_options;
				...
				echo '<div class="error fade" style="background-color:red;"><p><strong>FV All in One SEO Pack has new options. Go to <a href="' . admin_url( 'options-general.php?page=fv-all-in-one-seo-pack/aioseop.class.php' ) . '">the admin page</a> to enable and configure the plugin.</strong></p></div>';
}else{
		echo '<div class="error fade" style="background-color:red;"><p><strong>FV All in One SEO Pack must be configured. Go to <a href="' . get_option('siteurl') . 'options-general.php?page=fv-all-in-one-seo-pack/aioseop.class.php' . '">the admin page</a> to enable and configure the plugin.</strong></p></div>';
}
}
...
function aiosp_meta_box_add() {
	if ( function_exists('add_meta_box') ) {
		add_meta_box('aiosp',__('FV All in One SEO Pack', 'all_in_one_seo_pack'),'aiosp_meta','post');
		add_meta_box('aiosp',__('FV All in One SEO Pack', 'all_in_one_seo_pack'),'aiosp_meta','page');
	} else {
		add_action('dbx_post_advanced', array($aiosp, 'add_meta_tags_textinput'));
		add_action('dbx_page_advanced', array($aiosp, 'add_meta_tags_textinput'));
	}
...
<?php if ($aioseop_options['aiosp_show_keywords']) : ?>		
